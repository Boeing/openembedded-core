    ...
    def get_connection(self):
        if self.conn is None:
            self.conn = SerialConnection(self.connection_script,
                                         self.target_ps1, self.default_timeout)
...
class SerialConnection:
    ...
    def __init__(self, script, target_prompt, default_timeout):
    ...
    def _seek_to_clean_shell(self):
        ...
        INITIAL_CONNECT_TIMEOUT = 10 # seconds
    ...
    def run_command(self, cmd, timeout=None):
        ...
        return "\r\n".join(self.conn.before.splitlines()[1:])
